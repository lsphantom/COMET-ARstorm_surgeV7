...
public class YoutubePlayer : MonoBehaviour
{
    ...
    public void DoRegexFunctionsForAudio()
    {
        ...
        decryptedAudioUrlResult = HTTPHelperYoutube.ReplaceQueryStringParameter(EncryptUrlForAudio, SignatureQuery, AudioMagicResult);
        decryptedVideoUrlResult = HTTPHelperYoutube.ReplaceQueryStringParameter(EncryptUrlForVideo, SignatureQuery, VideoMagicResult);
